...
class acoustic_pressure(Operator):
    r"""Read/compute AcousticPressure by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.acoustic_pressure()
    ...
    def __init__(
        ...
        super().__init__(
            name="AcousticPressure",
            config=config,
            server=server,
            inputs_type=InputsAcousticPressure,
            outputs_type=OutputsAcousticPressure,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute AcousticPressure by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="AcousticPressure", server=server)

    @property
    def inputs(self) -> InputsAcousticPressure:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsAcousticPressure.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsAcousticPressure:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsAcousticPressure.
        """
        return self._outputs


class InputsAcousticPressure(_Inputs):
    """Intermediate class used to connect user inputs to
    acoustic_pressure operator.
...
class OutputsAcousticPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(acoustic_pressure._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            acoustic_pressure._spec().output_pin(0), 0, op
        )
