...
class enclosure_number(Operator):
    r"""Read/compute enclosure number by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.enclosure_number()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsEnclosureNumber,
            outputs_type=OutputsEnclosureNumber,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute enclosure number by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EnclosureNumber", server=server)

    @property
    def inputs(self) -> InputsEnclosureNumber:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsEnclosureNumber.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsEnclosureNumber:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsEnclosureNumber.
        """
        return self._outputs


class InputsEnclosureNumber(_Inputs):
    """Intermediate class used to connect user inputs to
    enclosure_number operator.
...
class OutputsEnclosureNumber(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(enclosure_number._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            enclosure_number._spec().output_pin(0), 0, op
        )
