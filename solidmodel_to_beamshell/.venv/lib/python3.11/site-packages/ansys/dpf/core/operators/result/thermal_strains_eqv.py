...
"""
    ...
    @property
    def inputs(self) -> InputsThermalStrainsEqv:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsThermalStrainsEqv.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsThermalStrainsEqv:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsThermalStrainsEqv.
        """
...
class InputsThermalStrainsEqv(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[Scoping | int | float | Field] = Input(
            thermal_strains_eqv._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping: Input[ScopingsContainer | Scoping] = Input(
            thermal_strains_eqv._spec().input_pin(1), 1, op, -1
        )
        ...
        self._data_sources: Input[DataSources] = Input(
            thermal_strains_eqv._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            thermal_strains_eqv._spec().input_pin(7), 7, op, -1
        )
