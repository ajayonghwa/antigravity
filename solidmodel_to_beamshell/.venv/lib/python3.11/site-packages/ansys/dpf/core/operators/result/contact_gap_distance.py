...
class InputsContactGapDistance(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._phi: Input[float] = Input(
            contact_gap_distance._spec().input_pin(19), 19, op, -1
        )
        self._inputs.append(self._phi)
        self._read_beams: Input[bool] = Input(
            contact_gap_distance._spec().input_pin(22), 22, op, -1
        )
        self._inputs.append(self._read_beams)
        self._split_shells: Input[bool] = Input(
            contact_gap_distance._spec().input_pin(26), 26, op, -1
        )
...
class OutputsContactGapDistance(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            contact_gap_distance._spec().output_pin(0), 0, op
        )
