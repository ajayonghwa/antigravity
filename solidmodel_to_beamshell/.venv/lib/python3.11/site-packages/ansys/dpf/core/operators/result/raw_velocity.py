...
class raw_velocity(Operator):
    r"""Read/compute V vector from the finite element problem MA+CV+KU=F by
    ...
    >>> op = dpf.operators.result.raw_velocity()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsRawVelocity,
            outputs_type=OutputsRawVelocity,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute V vector from the finite element problem MA+CV+KU=F by
calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="VTOT", server=server)

    @property
    def inputs(self) -> InputsRawVelocity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsRawVelocity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsRawVelocity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsRawVelocity.
        """
        return self._outputs


class InputsRawVelocity(_Inputs):
    """Intermediate class used to connect user inputs to
    raw_velocity operator.
...
class OutputsRawVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(raw_velocity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            raw_velocity._spec().output_pin(0), 0, op
        )
