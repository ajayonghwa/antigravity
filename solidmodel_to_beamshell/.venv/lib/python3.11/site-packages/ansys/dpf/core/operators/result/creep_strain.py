...
class creep_strain(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsCreepStrain,
            outputs_type=OutputsCreepStrain,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPCR", server=server)

    @property
    def inputs(self) -> InputsCreepStrain:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsCreepStrain.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsCreepStrain:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsCreepStrain.
        """
        return self._outputs


class InputsCreepStrain(_Inputs):
    """Intermediate class used to connect user inputs to
    creep_strain operator.
...
class OutputsCreepStrain(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(creep_strain._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            creep_strain._spec().output_pin(0), 0, op
        )
