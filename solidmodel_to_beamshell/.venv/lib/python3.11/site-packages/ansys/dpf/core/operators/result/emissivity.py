...
class emissivity(Operator):
    r"""Read/compute emissivity by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.emissivity()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsEmissivity,
            outputs_type=OutputsEmissivity,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute emissivity by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="Emissivity", server=server)

    @property
    def inputs(self) -> InputsEmissivity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsEmissivity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsEmissivity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsEmissivity.
        """
        return self._outputs


class InputsEmissivity(_Inputs):
...
class OutputsEmissivity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(emissivity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            emissivity._spec().output_pin(0), 0, op
        )
