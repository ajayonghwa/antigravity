...
class nusselt_number(Operator):
    r"""Read/compute nusselt number by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.nusselt_number()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsNusseltNumber,
            outputs_type=OutputsNusseltNumber,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nusselt number by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="NusseltNumber", server=server)

    @property
    def inputs(self) -> InputsNusseltNumber:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsNusseltNumber.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsNusseltNumber:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsNusseltNumber.
        """
        return self._outputs


class InputsNusseltNumber(_Inputs):
    """Intermediate class used to connect user inputs to
    nusselt_number operator.
...
class OutputsNusseltNumber(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nusselt_number._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nusselt_number._spec().output_pin(0), 0, op
        )
