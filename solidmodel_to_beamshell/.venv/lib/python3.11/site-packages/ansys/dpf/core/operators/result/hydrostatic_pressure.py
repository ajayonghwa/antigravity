...
class hydrostatic_pressure(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsHydrostaticPressure,
            outputs_type=OutputsHydrostaticPressure,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsHydrostaticPressure:
...
class InputsHydrostaticPressure(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._read_beams: Input[bool] = Input(
            hydrostatic_pressure._spec().input_pin(22), 22, op, -1
        )
        self._inputs.append(self._read_beams)
        self._split_shells: Input[bool] = Input(
            hydrostatic_pressure._spec().input_pin(26), 26, op, -1
        )
...
class OutputsHydrostaticPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            hydrostatic_pressure._spec().output_pin(0), 0, op
        )
