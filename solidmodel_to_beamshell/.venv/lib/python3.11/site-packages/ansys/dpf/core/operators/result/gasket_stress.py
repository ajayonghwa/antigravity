...
class InputsGasketStress(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._requested_location: Input[str] = Input(
            gasket_stress._spec().input_pin(9), 9, op, -1
        )
        self._inputs.append(self._requested_location)
        self._split_shells: Input[bool] = Input(
            gasket_stress._spec().input_pin(26), 26, op, -1
        )
        self._inputs.append(self._split_shells)
        self._shell_layer: Input[int] = Input(
            gasket_stress._spec().input_pin(27), 27, op, -1
        )
...
class OutputsGasketStress(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            gasket_stress._spec().output_pin(0), 0, op
        )
