...
"""
    ...
    @property
    def inputs(self) -> InputsStateVariable:
...
class OutputsStateVariable(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            state_variable._spec().output_pin(0), 0, op
        )
