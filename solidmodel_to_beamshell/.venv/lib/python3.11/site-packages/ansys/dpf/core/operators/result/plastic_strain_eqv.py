...
class plastic_strain_eqv(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsPlasticStrainEqv,
            outputs_type=OutputsPlasticStrainEqv,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="EPPL_EQV", server=server)

    @property
    def inputs(self) -> InputsPlasticStrainEqv:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPlasticStrainEqv.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPlasticStrainEqv:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPlasticStrainEqv.
        """
        return self._outputs


class InputsPlasticStrainEqv(_Inputs):
    """Intermediate class used to connect user inputs to
    plastic_strain_eqv operator.
...
class OutputsPlasticStrainEqv(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(plastic_strain_eqv._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_strain_eqv._spec().output_pin(0), 0, op
        )
