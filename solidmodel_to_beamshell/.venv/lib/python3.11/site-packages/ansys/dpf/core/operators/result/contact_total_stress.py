...
class InputsContactTotalStress(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping: Input[Scoping | int | float | Field] = Input(
            contact_total_stress._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping: Input[ScopingsContainer | Scoping] = Input(
            contact_total_stress._spec().input_pin(1), 1, op, -1
        )
        ...
        self._data_sources: Input[DataSources] = Input(
            contact_total_stress._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            contact_total_stress._spec().input_pin(7), 7, op, -1
        )
        self._inputs.append(self._mesh)
        self._requested_location: Input[str] = Input(
            contact_total_stress._spec().input_pin(9), 9, op, -1
        )
        ...
        self._phi: Input[float] = Input(
            contact_total_stress._spec().input_pin(19), 19, op, -1
        )
        self._inputs.append(self._phi)
        self._read_beams: Input[bool] = Input(
            contact_total_stress._spec().input_pin(22), 22, op, -1
        )
        self._inputs.append(self._read_beams)
        self._split_shells: Input[bool] = Input(
            contact_total_stress._spec().input_pin(26), 26, op, -1
        )
