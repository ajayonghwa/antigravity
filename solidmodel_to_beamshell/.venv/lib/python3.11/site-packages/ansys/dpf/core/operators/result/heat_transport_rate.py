...
class heat_transport_rate(Operator):
    r"""Read/compute heat transport rate by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.heat_transport_rate()
    ...
    def __init__(
        ...
        super().__init__(
            name="HeatTransportRate",
            config=config,
            server=server,
            inputs_type=InputsHeatTransportRate,
            outputs_type=OutputsHeatTransportRate,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute heat transport rate by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="HeatTransportRate", server=server)

    @property
    def inputs(self) -> InputsHeatTransportRate:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsHeatTransportRate.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsHeatTransportRate:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsHeatTransportRate.
        """
        return self._outputs


class InputsHeatTransportRate(_Inputs):
    """Intermediate class used to connect user inputs to
    heat_transport_rate operator.
...
class OutputsHeatTransportRate(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(heat_transport_rate._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            heat_transport_rate._spec().output_pin(0), 0, op
        )
