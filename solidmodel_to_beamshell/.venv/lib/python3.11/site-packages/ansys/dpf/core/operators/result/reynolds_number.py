...
class reynolds_number(Operator):
    r"""Read/compute reynolds number by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.reynolds_number()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReynoldsNumber,
            outputs_type=OutputsReynoldsNumber,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute reynolds number by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ReynoldsNumber", server=server)

    @property
    def inputs(self) -> InputsReynoldsNumber:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReynoldsNumber.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReynoldsNumber:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReynoldsNumber.
        """
        return self._outputs


class InputsReynoldsNumber(_Inputs):
    """Intermediate class used to connect user inputs to
    reynolds_number operator.
...
class OutputsReynoldsNumber(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reynolds_number._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reynolds_number._spec().output_pin(0), 0, op
        )
