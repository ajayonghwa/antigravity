...
class average_velocity(Operator):
    r"""Read/compute average velocity by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.average_velocity()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsAverageVelocity,
            outputs_type=OutputsAverageVelocity,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute average velocity by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="Veloc", server=server)

    @property
    def inputs(self) -> InputsAverageVelocity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsAverageVelocity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsAverageVelocity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsAverageVelocity.
        """
        return self._outputs


class InputsAverageVelocity(_Inputs):
    """Intermediate class used to connect user inputs to
    average_velocity operator.
...
class OutputsAverageVelocity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(average_velocity._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            average_velocity._spec().output_pin(0), 0, op
        )
