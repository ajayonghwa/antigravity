...
class InputsEqvStressParameter(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._read_beams: Input[bool] = Input(
            eqv_stress_parameter._spec().input_pin(22), 22, op, -1
        )
        self._inputs.append(self._read_beams)
        self._split_shells: Input[bool] = Input(
            eqv_stress_parameter._spec().input_pin(26), 26, op, -1
        )
...
class OutputsEqvStressParameter(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            eqv_stress_parameter._spec().output_pin(0), 0, op
        )
