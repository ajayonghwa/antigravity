...
class InputsFcGetAttribute(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Input[FieldsContainer] = Input(
            fc_get_attribute._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._property_name: Input[str] = Input(
            fc_get_attribute._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._property_name)
        self._property_identifier: Input[str | int] = Input(
    ...
    @property
    def property_identifier(self) -> Input[str | int]:
...
class OutputsFcGetAttribute(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self.property_as_string_field = Output(
            _modify_output_spec_with_one_type(
                fc_get_attribute._spec().output_pin(0), "string_field"
            ),
            0,
            op,
        )
