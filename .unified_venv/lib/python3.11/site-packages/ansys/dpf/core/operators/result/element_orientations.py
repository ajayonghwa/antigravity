...
class InputsElementOrientations(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._read_beams: Input[bool] = Input(
            element_orientations._spec().input_pin(22), 22, op, -1
        )
        self._inputs.append(self._read_beams)
        self._split_shells: Input[bool] = Input(
            element_orientations._spec().input_pin(26), 26, op, -1
        )
...
class OutputsElementOrientations(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            element_orientations._spec().output_pin(0), 0, op
        )
