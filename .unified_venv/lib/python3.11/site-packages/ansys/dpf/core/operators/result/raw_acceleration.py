...
class raw_acceleration(Operator):
    r"""Read/compute A vector from the finite element problem MA+CV+KU=F by
    ...
    >>> op = dpf.operators.result.raw_acceleration()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsRawAcceleration,
            outputs_type=OutputsRawAcceleration,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute A vector from the finite element problem MA+CV+KU=F by
calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ATOT", server=server)

    @property
    def inputs(self) -> InputsRawAcceleration:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsRawAcceleration.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsRawAcceleration:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsRawAcceleration.
        """
        return self._outputs


class InputsRawAcceleration(_Inputs):
    """Intermediate class used to connect user inputs to
    raw_acceleration operator.
...
class OutputsRawAcceleration(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(raw_acceleration._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            raw_acceleration._spec().output_pin(0), 0, op
        )
