...
class heat_flux(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsHeatFlux,
            outputs_type=OutputsHeatFlux,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsHeatFlux:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsHeatFlux.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsHeatFlux:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsHeatFlux.
        """
...
class OutputsHeatFlux(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            heat_flux._spec().output_pin(0), 0, op
        )
