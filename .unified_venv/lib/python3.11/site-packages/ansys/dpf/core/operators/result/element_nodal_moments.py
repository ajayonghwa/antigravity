...
class element_nodal_moments(Operator):
    r"""Read/compute element nodal moments by calling the readers defined by the
    ...
    element_nodal_moments fields contain STATIC, DAMPING and INERTIA forces
    ...
    >>> op = dpf.operators.result.element_nodal_moments()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsElementNodalMoments,
            outputs_type=OutputsElementNodalMoments,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal moments by calling the readers defined by the
datasources. - The ‘requested_location’ and ‘mesh_scoping’ inputs are
processed to see if they need scoping transposition or result averaging.
The resulting output fields have a ‘Nodal’, ‘ElementalNodal’ or
‘Elemental’ location. - Once the need for averaging has been detected,
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ENF_Moment", server=server)

    @property
    def inputs(self) -> InputsElementNodalMoments:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsElementNodalMoments.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsElementNodalMoments:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsElementNodalMoments.
        """
        return self._outputs


class InputsElementNodalMoments(_Inputs):
    """Intermediate class used to connect user inputs to
    element_nodal_moments operator.
...
class OutputsElementNodalMoments(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(element_nodal_moments._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            element_nodal_moments._spec().output_pin(0), 0, op
        )
