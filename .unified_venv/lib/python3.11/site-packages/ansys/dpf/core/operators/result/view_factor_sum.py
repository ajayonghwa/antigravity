...
class view_factor_sum(Operator):
    r"""Read/compute view factor sum by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.view_factor_sum()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsViewFactorSum,
            outputs_type=OutputsViewFactorSum,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute view factor sum by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ViewFactorSum", server=server)

    @property
    def inputs(self) -> InputsViewFactorSum:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsViewFactorSum.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsViewFactorSum:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsViewFactorSum.
        """
        return self._outputs


class InputsViewFactorSum(_Inputs):
    """Intermediate class used to connect user inputs to
    view_factor_sum operator.
...
class OutputsViewFactorSum(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(view_factor_sum._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            view_factor_sum._spec().output_pin(0), 0, op
        )
