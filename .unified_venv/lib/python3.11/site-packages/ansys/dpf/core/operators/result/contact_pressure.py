...
class contact_pressure(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsContactPressure,
            outputs_type=OutputsContactPressure,
        )
...
class OutputsContactPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            contact_pressure._spec().output_pin(0), 0, op
        )
