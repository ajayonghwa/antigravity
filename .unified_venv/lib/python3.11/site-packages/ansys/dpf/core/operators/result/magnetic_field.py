...
class magnetic_field(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsMagneticField,
            outputs_type=OutputsMagneticField,
        )
...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="MF", server=server)

    @property
    def inputs(self) -> InputsMagneticField:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMagneticField.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMagneticField:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMagneticField.
        """
        return self._outputs


class InputsMagneticField(_Inputs):
    """Intermediate class used to connect user inputs to
    magnetic_field operator.
...
class OutputsMagneticField(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(magnetic_field._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            magnetic_field._spec().output_pin(0), 0, op
        )
