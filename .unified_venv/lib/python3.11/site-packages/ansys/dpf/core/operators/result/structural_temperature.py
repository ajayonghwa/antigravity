...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="BFE", server=server)

    @property
    def inputs(self) -> InputsStructuralTemperature:
...
class InputsStructuralTemperature(_Inputs):
    ...
    structural_temperature operator.
...
class OutputsStructuralTemperature(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            structural_temperature._spec().output_pin(0), 0, op
        )
