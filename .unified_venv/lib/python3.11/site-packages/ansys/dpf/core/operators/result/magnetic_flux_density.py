...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="MFD", server=server)

    @property
    def inputs(self) -> InputsMagneticFluxDensity:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsMagneticFluxDensity.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsMagneticFluxDensity:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsMagneticFluxDensity.
        """
        return self._outputs


class InputsMagneticFluxDensity(_Inputs):
    """Intermediate class used to connect user inputs to
    magnetic_flux_density operator.
    ...
    def __init__(self, op: Operator):
        ...
        self._split_shells: Input[bool] = Input(
            magnetic_flux_density._spec().input_pin(26), 26, op, -1
        )
...
class OutputsMagneticFluxDensity(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(magnetic_flux_density._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            magnetic_flux_density._spec().output_pin(0), 0, op
        )
