...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ENL_SRAT", server=server)

    @property
    def inputs(self) -> InputsStressRatio:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsStressRatio.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsStressRatio:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsStressRatio.
        """
...
class OutputsStressRatio(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            stress_ratio._spec().output_pin(0), 0, op
        )
