...
"""
        spec = Specification(
            ...
            map_input_pin_spec={
                0: PinSpecification(
                    ...
                    optional=False,
                    document=r"""field_or_fields_container""",
                ),
                1: PinSpecification(
                    name="file_path",
                    type_names=["string"],
                ...
                2: PinSpecification(
                    ...
                    type_names=["int32"],
                    optional=True,
                    document=r"""storage type : if matrices (without any particularity) are included in the fields container, the storage format can be chosen. 0 : flat/line format, 1 : ranked format. If 1 is chosen, the csv can not be read by "csv to field" operator anymore. Default : 0.""",
                ),
            },
            map_output_pin_spec={},
        )
    ...
    @property
    def inputs(self) -> InputsFieldToCsv:
