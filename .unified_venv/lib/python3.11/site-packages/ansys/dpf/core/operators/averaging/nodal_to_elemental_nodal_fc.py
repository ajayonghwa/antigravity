...
class nodal_to_elemental_nodal_fc(Operator):
    ...
    def __init__(
        ...
        super().__init__(
            name="nodal_to_elemental_nodal_fc",
            config=config,
            server=server,
            inputs_type=InputsNodalToElementalNodalFc,
            outputs_type=OutputsNodalToElementalNodalFc,
        )
...
class InputsNodalToElementalNodalFc(_Inputs):
    ...
    nodal_to_elemental_nodal_fc operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_to_elemental_nodal_fc._spec().inputs, op)
        self._fields_container: Input[FieldsContainer] = Input(
            nodal_to_elemental_nodal_fc._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._fields_container)
        self._mesh: Input[MeshedRegion] = Input(
            nodal_to_elemental_nodal_fc._spec().input_pin(1), 1, op, -1
        )
...
class OutputsNodalToElementalNodalFc(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(nodal_to_elemental_nodal_fc._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_to_elemental_nodal_fc._spec().output_pin(0), 0, op
        )
