...
class prandtl_number(Operator):
    r"""Read/compute prandtl number by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.prandtl_number()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsPrandtlNumber,
            outputs_type=OutputsPrandtlNumber,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute prandtl number by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="PrandtlNumber", server=server)

    @property
    def inputs(self) -> InputsPrandtlNumber:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsPrandtlNumber.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsPrandtlNumber:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsPrandtlNumber.
        """
        return self._outputs


class InputsPrandtlNumber(_Inputs):
    """Intermediate class used to connect user inputs to
    prandtl_number operator.
...
class OutputsPrandtlNumber(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(prandtl_number._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            prandtl_number._spec().output_pin(0), 0, op
        )
