...
class heat_conductivity_rate(Operator):
    r"""Read/compute heat conductivity rate by calling the readers defined by
    the datasources.
    ...
    >>> op = dpf.operators.result.heat_conductivity_rate()
    ...
    def __init__(
        ...
        super().__init__(
            name="HeatConductivityRate",
            config=config,
            server=server,
            inputs_type=InputsHeatConductivityRate,
            outputs_type=OutputsHeatConductivityRate,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute heat conductivity rate by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="HeatConductivityRate", server=server)

    @property
    def inputs(self) -> InputsHeatConductivityRate:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsHeatConductivityRate.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsHeatConductivityRate:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsHeatConductivityRate.
        """
        return self._outputs


class InputsHeatConductivityRate(_Inputs):
    """Intermediate class used to connect user inputs to
    heat_conductivity_rate operator.
...
class OutputsHeatConductivityRate(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(heat_conductivity_rate._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            heat_conductivity_rate._spec().output_pin(0), 0, op
        )
