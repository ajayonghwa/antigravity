...
class film_coefficient(Operator):
    r"""Read/compute film coefficient by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.film_coefficient()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsFilmCoefficient,
            outputs_type=OutputsFilmCoefficient,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute film coefficient by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="FilmCoefficient", server=server)

    @property
    def inputs(self) -> InputsFilmCoefficient:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsFilmCoefficient.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsFilmCoefficient:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsFilmCoefficient.
        """
        return self._outputs


class InputsFilmCoefficient(_Inputs):
    """Intermediate class used to connect user inputs to
    film_coefficient operator.
...
class OutputsFilmCoefficient(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(film_coefficient._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            film_coefficient._spec().output_pin(0), 0, op
        )
