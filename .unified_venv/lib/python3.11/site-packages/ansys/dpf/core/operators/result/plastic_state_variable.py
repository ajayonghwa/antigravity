...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ENL_PSV", server=server)

    @property
    def inputs(self) -> InputsPlasticStateVariable:
...
class InputsPlasticStateVariable(_Inputs):
    ...
    plastic_state_variable operator.
    ...
    def __init__(self, op: Operator):
        ...
        self._split_shells: Input[bool] = Input(
            plastic_state_variable._spec().input_pin(26), 26, op, -1
        )
...
class OutputsPlasticStateVariable(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            plastic_state_variable._spec().output_pin(0), 0, op
        )
