...
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="TG", server=server)

    @property
    def inputs(self) -> InputsTemperatureGrad:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTemperatureGrad.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTemperatureGrad:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTemperatureGrad.
        """
...
class OutputsTemperatureGrad(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            temperature_grad._spec().output_pin(0), 0, op
        )
