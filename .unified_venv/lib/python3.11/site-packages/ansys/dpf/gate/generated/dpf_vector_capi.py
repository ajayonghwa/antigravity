...
class DpfVectorCAPI(dpf_vector_abstract_api.DpfVectorAbstractAPI):
	...
	def dpf_vector_char_ptr_free_with_size(dpf_vector, data, var1, size, modified):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.DpfVector_char_ptr_free_with_size(dpf_vector._internal_obj, utils.to_char_ptr_ptr_ptr(data), var1, utils.to_int32_ptr(size), modified, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def dpf_vector_char_ptr_free_for_next_usage_with_size(dpf_vector, data, var1, size, modified):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.DpfVector_char_ptr_free_for_next_usage_with_size(dpf_vector._internal_obj, utils.to_char_ptr_ptr_ptr(data), var1, utils.to_int32_ptr(size), modified, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
	...
	def dpf_string_free(dpf_vector, data, var1):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.DpfString_free(dpf_vector, utils.to_char_ptr(data), utils.to_int32(var1), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
