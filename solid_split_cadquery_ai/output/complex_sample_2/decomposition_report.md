...
- **전체 크기 (Bounding Box)**: [60.0, 60.0, 30.0]
- **감지된 주요 피처 수**: 4

## 2. 기하학적 특징 분석 (Feature Extraction)
AI가 형상에서 추출한 주요 데이터입니다:
- **피처 1**: Type: `stepped_hole`, Location: `[15.0, 15.0, 30.0]`
- **피처 2**: Type: `step`, Location: `N/A`
- **피처 3**: Type: `junction`, Location: `[0.429, 10.0, 10.0]`
- **피처 4**: Type: `junction`, Location: `[0.0, 12.5, 10.0]`
...
| 순서 | 작업 유형 | 축 | 좌표 | 이유 |
| :--- | :--- | :--- | :--- | :--- |
| 1 | plane_cut | Z | 10.0 | Junction-based heuristic split |
| 2 | plane_cut | Z | 10.0 | Junction-based heuristic split |
